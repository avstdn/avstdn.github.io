...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServiceChooser = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var services = this.props.items.map(function (s, i) {
	      ...
	      return _react2.default.createElement(Service, { name: s.name, key: i, price: s.price, active: s.active, addTotal: self.addTotal });
	    });
	...
	var services = [{ name: 'Веб-разработка', price: 300 }, { name: 'Дизайн', price: 400 }, { name: 'Интеграция', price: 250 }, { name: 'Обучение', price: 220 }];

	// Отображаем ServiceChooser и передаем
	// ему массив с перечнем услуг
	_reactDom2.default.render(_react2.default.createElement(ServiceChooser, { items: services }), document.getElementById("sample"));
